    ...
    public boolean esPreguntaSimilar(String preguntaTexto, Long usuarioId, List<String> ultimasPreguntas) {
        ...
        try {
            ...
            EmbeddingSearchRequest searchRequest = EmbeddingSearchRequest.builder()
                    ...
                    .maxResults(100)
                    .minScore(0.85) // Umbral de similitud de coseno (ajustado a 0.85 para detectar reformulaciones
                                    // semánticas)
                    .build();
            ...
            for (var match : matches) {
                ...
                if ("pregunta".equals(tipo) && String.valueOf(usuarioId).equals(matchUsuarioId)) {
                    log.info(
                            "[DEDUP-QDRANT] Coincidencia vectorial con pregunta en historial Qdrant (score={}): '{}' vs '{}'",
