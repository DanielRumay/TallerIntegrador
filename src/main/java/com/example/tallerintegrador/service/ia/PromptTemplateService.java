    ...
    private String obtenerEjemplosPorTipo(String tipo) {
        return switch (tipo) {
            ...
            case DETECCION_ERRORES -> """
                ...
                [EJEMPLO 2 — Nivel: Comprender]
                Enunciado: Los pulmones forman parte del sistema digestivo. Allí la sangre recibe nitrógeno y lo lleva a todo el cuerpo.
                Opciones_o_respuesta: ["digestivo", "nitrógeno"]
                Respuesta_correcta: respiratorio | oxígeno
                Justificacion: Los pulmones pertenecen al sistema respiratorio y en ellos la sangre recibe oxígeno. Cada corrección tiene el mismo género y número que su error, así que la oración sigue siendo correcta; los artículos y conectores se quedan fuera de los huecos.
                """;
            case VISUAL_QUIZ -> """
